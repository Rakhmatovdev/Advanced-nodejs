...
const CreatePost = () => {
    ...
    const form = useForm<z.infer<typeof postSchema>>({
      ...
      const promise=$axios.post("/post/create",formData).then(res=>console.log(res)).catch(err=>console.log(err)).finally(()=>setLoading(false))
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="Create a blog post..." {...field} disabled={loading} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea placeholder="In this article you can improve..." {...field} disabled={loading} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
